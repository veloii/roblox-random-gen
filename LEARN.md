...
A completely standalone roblox random game generator. Most of the interesting parts are in the [API Call](https://github.com/TheEmptynessProject/roblox-random-gen/blob/main/pages/api/get-random.tsx). The index page when you go to the site is just some front end stuff with TailwindCSS.
...
### Check it out at [random-roblox-game.vercel.app](https://roblox-random-game-gen.vercel.app/)
